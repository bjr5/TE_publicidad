                ...
                <div class="card">
                    <div class="card-body">
                        <form action="Controlador?menu=Usuario" method="POST">
                            ...
                            <div class="form-group">
                                <label>Paterno</label>
                                <input type="text" value="${usuario.getApe_pat()}" name="txtPaterno" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Materno</label>
                                <input type="text" value="${usuario.getApe_mat()}" name="txtMaterno" class="form-control">
                            </div>       
                             <div class="form-group">
                                <label>Celular</label>
                            ...
                            <a class="btn btn-primary" href="Controlador?menu=Usuario&accion=Agregar&id=${u.getId()}">Nuevo</a>
                               </c:forEach>
